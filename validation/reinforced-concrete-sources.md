...
| `rc-column-ntc2018-slenderness-screening` | primary-method-reference | D.M. 17 gennaio 2018, NTC 2018 § 4.1.2.3.9.2, equations 4.1.41-4.1.42 | Axial-load ratio, radii of gyration and slenderness screening about both section components | High for screening arithmetic; nominal-stiffness generation is covered by application regression tests |
