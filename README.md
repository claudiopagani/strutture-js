...
- il dominio `M-N` e attualmente costruito per punti a partire da una lista di valori `N` fornita in input; non e ancora presente una generazione automatica e normativamente ragionata dell'intero intervallo di dominio;
