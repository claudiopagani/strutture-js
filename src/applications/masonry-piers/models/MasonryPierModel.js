...
function normalizePlainMaterial(material) {
  ...
  return {
    ...
    elasticModulus: unitResolver.stress(material.elasticModulus),
    shearModulus: unitResolver.stress(material.shearModulus),
    density: unitResolver.volumeLoad(material.density),
