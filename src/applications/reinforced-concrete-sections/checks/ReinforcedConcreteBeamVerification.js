...
export class ReinforcedConcreteBeamVerification {
  ...
  verify({
    ...
    const detailingVerification = detailing
    ...
    if (detailingVerification) {
      ...
      actionVerification.checks = [
        ...actionVerification.checks,
        ...detailingVerification.checks,
      ];
      actionVerification.warnings = [
        ...actionVerification.warnings,
        ...detailingVerification.warnings,
      ];
      actionVerification.assumptions = [
        ...actionVerification.assumptions,
        ...detailingVerification.assumptions,
      ];
    ...
    return new VerificationResult({
      ...
      outputs: {
        ...
        detailing: actionVerification.outputs.detailing ??
          detailingVerification?.toJSON() ?? null,
      ...
      warnings: [
        ...
        ...(shear
          ? [
              torsion
                ? detailing ? null : "Full member detailing is not included because no detailing contract was supplied."
                : detailing ? "Torsion is not included in this RC beam verification step." : "Torsion and full member detailing are not included in this RC beam verification step.",
            ]
          : [
              torsion
                ? detailing ? "Shear resistance is not included in this RC beam verification step." : "Shear resistance and full member detailing are not included in this RC beam verification step."
                : detailing ? "Shear resistance and torsion are not included in this RC beam verification step." : "Shear resistance, torsion and full member detailing are not included in this RC beam verification step.",
            ]).filter(Boolean),
      ],
      assumptions: [
        ...actionVerification.assumptions,
