# Validazione deformata RC doppiamente incastrata
...
| --- | ---: | ---: | --- |
| 1. Interamente reagente (FEM, sezione omogeneizzata n=15) | 0.127 | 2.5 | Cls interamente reagente, armatura trasformata con n = 15. |
| 2. Totalmente fessurata (curvatura fessurata pura) | 0.885 | 2.5 | Cls teso escluso in tutta la trave, senza tension stiffening. |
| 3. Metodo app (Mcr + tension stiffening) | 0.612 | 2.5 | Curvatura media con zeta = 1 - beta (Mcr/M)^2 sopra Mcr. |

## Dati sezione e fessurazione

- Momento di prima fessurazione Mcr: 32 kNm
- Fibre cls usate nel solve fessurato: 308
- Freccia governante metodo app: 0.612 mm
- Freccia governante totalmente fessurata: 0.885 mm
